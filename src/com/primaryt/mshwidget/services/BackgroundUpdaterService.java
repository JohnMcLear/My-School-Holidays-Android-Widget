	...
	private void updateTextInfo(ArrayList<Event> eventList) {
		...
		if (event != null) {
			for (int i = 0; i < appWidgetIds.length; i++) {
				...
				if (nextEventDate != null) {
					...
					try {
						...
						if (event.getCurrentEvent().equals("Holiday")) {
							...
							remoteViews.setImageViewResource(
									R.id.imageViewTextHoliday,
									R.drawable.holiday_text);
						}

						remoteViews.setImageViewResource(
								R.id.date_0,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(8) + "",
										"drawable", "com.primaryt.mshwidget"));

						remoteViews.setImageViewResource(
								R.id.date_1,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(9) + "",
										"drawable", "com.primaryt.mshwidget"));

						remoteViews.setImageViewResource(
								R.id.month_0,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(5) + "",
										"drawable", "com.primaryt.mshwidget"));
						remoteViews.setImageViewResource(
								R.id.month_1,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(6) + "",
										"drawable", "com.primaryt.mshwidget"));

						remoteViews.setImageViewResource(
								R.id.year_0,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(0) + "",
										"drawable", "com.primaryt.mshwidget"));
						remoteViews.setImageViewResource(
								R.id.year_1,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(1) + "",
										"drawable", "com.primaryt.mshwidget"));
						remoteViews.setImageViewResource(
								R.id.year_2,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(2) + "",
										"drawable", "com.primaryt.mshwidget"));
						remoteViews.setImageViewResource(
								R.id.year_3,
								getResources().getIdentifier(
										"date_" + nextEventDate.charAt(3) + "",
										"drawable", "com.primaryt.mshwidget"));
						...
						if (diffDays < 10) {
							...
							remoteViews.setImageViewResource(
									R.id.imageDay1,
									getResources().getIdentifier(
											"cal_" + tensPlace, "drawable",
											"com.primaryt.mshwidget"));
							remoteViews.setImageViewResource(
									R.id.imageDay2,
									getResources().getIdentifier(
											"cal_" + onesPlace, "drawable",
											"com.primaryt.mshwidget"));
						}

						remoteViews
								.setViewVisibility(R.id.date_0, View.VISIBLE);
						remoteViews
								.setViewVisibility(R.id.date_1, View.VISIBLE);
						remoteViews.setViewVisibility(R.id.imageView4,
								View.VISIBLE);
						remoteViews.setViewVisibility(R.id.month_0,
								View.VISIBLE);
						remoteViews.setViewVisibility(R.id.month_1,
								View.VISIBLE);
						remoteViews.setViewVisibility(R.id.imageView5,
								View.VISIBLE);
						remoteViews
								.setViewVisibility(R.id.year_0, View.VISIBLE);
						remoteViews
								.setViewVisibility(R.id.year_1, View.VISIBLE);
						remoteViews
								.setViewVisibility(R.id.year_2, View.VISIBLE);
						remoteViews
								.setViewVisibility(R.id.year_3, View.VISIBLE);
				...
				remoteViews.setOnClickPendingIntent(R.id.relativeLayout1,
						pendingIntent);
		...
		public void handleMessage(Message msg) {
			...
			if (msg.getData() != null) {
				if (msg.getData().containsKey("value")) {
					ArrayList<Event> eventList = (ArrayList<Event>) msg
							.getData().get("value");
	...
	public void onCreate() {
		...
		if (Config.LOGGING) {
			String logfilePath = Environment.getExternalStorageDirectory()
					.getAbsolutePath() + File.separator + "msh";
